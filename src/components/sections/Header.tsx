    ...
    <header className="sticky top-0 z-50 bg-transparent w-full">
      ...
      <div className="flex items-center justify-between w-full px-4 md:px-6 lg:px-[30px] py-[15px]">
        ...
        <a
          ...
          className="flex h-[36px] md:h-[44px] px-4 md:px-6 py-2 md:py-[14px] justify-center items-center gap-[14px] rounded-[14px] text-white font-semibold text-[15px] md:text-[18px] leading-[140%] transition-colors duration-200 whitespace-nowrap"
          style={{ backgroundColor: "#60B5FF" }}
          onMouseEnter={e => (e.currentTarget.style.backgroundColor = "#40A5FF")}
