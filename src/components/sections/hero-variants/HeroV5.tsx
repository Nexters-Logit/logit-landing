...
export default function HeroV5() {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center overflow-hidden">
      {/* 배경 목업 이미지 (placeholder) */}
      <div className="absolute inset-0 bg-primary-50" />

      {/* 그라디언트 오버레이 — 왼쪽은 흰색, 오른쪽은 투명 */}
      ...
      <div className="relative z-10 w-full px-8 md:px-16 lg:px-24 xl:px-36 py-20 lg:py-32">
        <div className="max-w-2xl lg:max-w-3xl flex flex-col gap-8 lg:gap-10">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="flex items-center gap-3 border border-grey-70 hover:border-grey-200 text-grey-300 hover:text-grey-400 text-base font-medium px-6 py-3 rounded-xl transition-colors duration-200 bg-white/80">
